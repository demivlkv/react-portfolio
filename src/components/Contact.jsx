            ...
            <div>
                <form method="POST" action="https://getform.io/f/334ec745-eba1-4f48-a06a-ba6ee7e3fd13" id="contact-form" onSubmit={handleSubmit} className="flex flex-col justify-center max-w-[600px] w-full">
                    <div class="w-[75%] mx-auto">
                        <label className="block font-medium uppercase text-[#94b0b3]">Name:</label>
                        <input type="text" defaultValue={name} onBlur={handleChange} name="name" className="w-full my-3 p-2 rounded bg-[#84d5bb18] border border-[#84d5bb5a]" />

                        <label className="block font-medium uppercase text-[#94b0b3]">E-mail:</label>
                        <input type="email" defaultValue={email} onBlur={handleChange} name="email" className="w-full my-3 p-2 rounded bg-[#84d5bb18] border border-[#84d5bb5a]" />

                        <label className="block font-medium uppercase text-[#94b0b3]">Message:</label>
                        <textarea name="message" defaultValue={message} onBlur={handleChange} rows="5" className="w-full my-3 p-2 rounded bg-[#84d5bb18] border border-[#84d5bb5a]" />
                        ...
                        <button type="submit" className="text-[#84d5bc] group w-[120px] border-2 rounded mx-auto my-2 pl-6 py-2 flex items-center hover:bg-[#84d5bb2f] hover:text-[#94b0b3] hover:border-[#c1e2d8] hover:transition-all">
                            Submit
