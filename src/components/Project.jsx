            ...
            {projects.map((project) => (
                <div className="max-w-md h-max aspect-auto overflow-hidden rounded-lg opacity-80 hover:opacity-100 transition-all bg-gray-800 shadow-lg shadow-[#1c2025] cursor-pointer">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            class="flex justify-center items-center transition-all opacity-0 bg-gradient-to-t from-gray-900 via-[#8aa2a9] to-opacity-30 group-hover:opacity-90 absolute top-0 left-0 h-full w-full">
                        </div>
