    ...
    return (
        <div name="home" className="w-full h-screen">
            <div className="max-w-screen-lg mx-auto px-16 flex flex-col justify-center h-full">
                ...
                <h1 className="text-5xl sm:text-7xl font-bold text-[#9fdac7]">Demi Hayashi</h1>
                <h2 className="text-5xl sm:text-7xl font-bold text-[#a5bdc0]">I'm a full-stack web developer</h2>
                ...
                <div>
                    <button onclick="window.location('')" className="text-[#84d5bc] group w-[170px] border-2 rounded pl-6 py-2 my-2 flex items-center hover:bg-[#84d5bb2f] hover:text-[#94b0b3] hover:border-[#c1e2d8] transition-all">
                        Download CV
