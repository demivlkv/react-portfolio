  ...
  return (
    <div name="home" className="w-full h-screen">
        <div className="max-w-screen-lg mx-auto px-16 flex flex-col justify-center h-full">
            <p className="text-3xl text-[#6fffe9]">Hello, my name is</p>
            ...
            <div>
                <button className="text-[white] group w-[154px] border-2 rounded pl-6 py-2 my-2 flex items-center hover:bg-[#6fffe92b] hover:text-[#6fffe9] hover:border-[#bbf7ee] hover:transition-all">
                    View Works
